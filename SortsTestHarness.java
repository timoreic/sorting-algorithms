...
/**
 ** Testharness to generate various different types of arrays of integers and
 * then sort them using various sorts.
 **
 ** Each sort is run REPEATS times, with the first result discarded, and the last
 * REPEATS-1 runs averaged to give the running time.
 **
 ** Authour: Andrew Turpin (andrew@cs.curtin.edu.au) Date: August 2004 Modified:
 * Patrick Peursum Date: Sep 2009
 */
class SortsTestHarness {
    ...
    private static void usage() {
        ...
        System.out.println("           q - quicksort (leftmost)");
        System.out.println("           m - mergesort");
        System.out.println("           3 - quicksort (median of 3)");
